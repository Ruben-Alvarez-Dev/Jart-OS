...
```
 ...
 │   TIER-04 — AGENTS           Chiefs, tri-units                     │
...
### Boundary Rules
- TIER-00 is OUTSIDE Docker. Bare metal host. Port monitor, llama.cpp.
...
| Chief | Code | Domains | Why |
|-----------|------|---------|-----|
| CKO | `CKO` | `/study`, `/academic` | Exams = knowledge |
| CEngO | `CEngO` | `/dev`, `/infra` | Someone maintains Jart-OS |
| COO | `COO` | `/domain_subject` | Practical exam |

### Dormant (YAML only, zero RAM)

| Chief | Code | Domains | Wake when |
|-----------|------|---------|-----------|
| CCO | `CCO` | `/languages` | Active language study |
