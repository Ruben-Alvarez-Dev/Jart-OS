...
- `/Users/jarvis/Jart-OS/` → owned by `jarvis`
- `/Users/simba/Documents/PROJECT-Jart-OS/` → owned by `simba` (design docs, historical)
...
```
/Users/jarvis/Jart-OS/TIERS/TIER-02-GATEWAY/10201-proxy-litellm/config/litellm.yaml
Master key: sk-jart-os2026
...
# View LiteLLM models
curl -H "Authorization: Bearer sk-jart-os2026" http://localhost:10201/models
...
*Historical documents remain in /Users/simba/Documents/PROJECT-Jart-OS/ for reference only.*
